<#
Programa: thirdparty\Get-FolderACL.ps1
Objetivo: Lista usuários com permissão em uma pasta e subpastas
Autor: Martin Pugh https://community.spiceworks.com/people/martin9700
Link: https://community.spiceworks.com/topic/367228-list-users-with-access-to-specific-folder
